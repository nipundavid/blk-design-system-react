            ...
            <Row className="justify-content-between">
              <Col md="6">
                ...
                <p className="profile-description text-left">
                  ...
                  it has to be hyper-casual and since I am not very good at game
                  art tools I had to come up with a minimalist theme given that
                  I hardly get time to work on my projects I generally decide to
                  go with primitive mesh and be creative with what the tool has
                  to offer
                </p>
              </Col>
              <Col md="6">
